...
function ComboboxList({ className, ...props }: ComboboxPrimitive.List.Props) {
  return (
    <ComboboxPrimitive.List
      ...
      className={cn(
        "max-h-[min(calc(--spacing(96)---spacing(9)),calc(var(--available-height)---spacing(9)))] scroll-py-1 overflow-y-auto p-1 data-empty:p-0 touch-pan-y",
        className
      )}
      onWheel={(e) => {
        // Prevent wheel events from bubbling to sheet scroll container
        e.stopPropagation();
      }}
      onTouchStart={(e) => {
        // Prevent touch events from bubbling to sheet scroll container
        e.stopPropagation();
      }}
      onTouchMove={(e) => {
        // Prevent touch events from bubbling to sheet scroll container
